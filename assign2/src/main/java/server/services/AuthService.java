...
public class AuthService {
     ...
     *
     * @param out The PrintWriter used to send messages to the client.
     * @param in  The BufferedReader used to read input from the client.
    ...
    /**
     * Handles timeout scenarios during authentication.
     *
